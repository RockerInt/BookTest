...
namespace Utilities
{
    public static class WebUtilities
    {
        ...
        {
            return ConectAsync(method, baseAddress, path, data, headers).Result;
        }
        ...
        {
            return ConectAsync(method, baseAddress, path, httpContent, headers).Result;
        }

        public static string ValidateContent(HttpResponseMessage httpResponse)
        {
            string resp = null;
        ...
        {
            return JsonConvert.DeserializeObject<List<T>>(objs);
        }

        public static Dictionary<T, D> ToDictionary<T, D>(this string objs)
        {
            Dictionary<T, D> values = JsonConvert.DeserializeObject<Dictionary<T, D>>(objs);
